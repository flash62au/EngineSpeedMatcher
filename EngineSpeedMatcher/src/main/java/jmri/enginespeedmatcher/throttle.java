...
import jmri.enginespeedmatcher.logviewer.ui.LogViewerActivity;
import jmri.enginespeedmatcher.util.PermissionsHelper;
import jmri.enginespeedmatcher.util.PermissionsHelper.RequestCodes;
...
public class throttle extends AppCompatActivity implements android.gesture.GestureOverlayView.OnGestureListener, PermissionsHelper.PermissionsHelperGrantedCallback {
    ...
    protected final static int AUTO_INCREMENT_DECREMENT_OFF = 0;
    protected final static int AUTO_INCREMENT_DECREMENT_INCREMENT = 1;
    protected final static int AUTO_INCREMENT_DECREMENT_DECREMENT = 2;
    protected final static int AUTO_INCREMENT_DECREMENT_INVERT = 3;
...
//        Log.d("Engine_Driver","throttle: speedChange -  change: " + change + " speed: " + speed+ " scaleSpeed: " + scaleSpeed);
    ...
    protected void setAutoIncrementDecrement(int whichThrottle, int dir) {
        switch (dir) {
            case AUTO_INCREMENT_DECREMENT_OFF:
                 mAutoIncrement[whichThrottle] = false;
                 mAutoDecrement[whichThrottle] = false;
                 break;
            case AUTO_INCREMENT_DECREMENT_INCREMENT:
                 mAutoIncrement[whichThrottle] = true;
                 mAutoDecrement[whichThrottle] = false;
                 break;
            case AUTO_INCREMENT_DECREMENT_DECREMENT:
                 mAutoIncrement[whichThrottle] = false;
                 mAutoDecrement[whichThrottle] = true;
                break;
            case AUTO_INCREMENT_DECREMENT_INVERT:
...
//                Log.d("Engine_Driver", "onProgressChanged -- lj: " + limitedJump[whichThrottle] + " ai: " + mAutoIncrement[whichThrottle] + " ad: " + mAutoDecrement + " s: " + speed + " js: " + jumpSpeed);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        prefs = getSharedPreferences("jmri.enginespeedmatcher_preferences", 0);
